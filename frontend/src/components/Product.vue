...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ConditionQty" v-model="value.conditionQty"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ConditionQty :  {{value.conditionQty }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="SumOrderQty" v-model="value.sumOrderQty"/>
          </div>
          <div class="grey--text ml-4" v-else>
            SumOrderQty :  {{value.sumOrderQty }}
          </div>
